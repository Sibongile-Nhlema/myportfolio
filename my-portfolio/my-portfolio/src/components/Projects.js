...
export default function Projects() {
    return (
    <section id="projects" className="text-gray-800 bg-gray-500 body-font">
      <div className="container px-5 py-10 mx-auto text-center lg:px-40">
        <div className="flex flex-col w-full mb-20">
          ...
          <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
            I have build a wide range of solution based projects. I build apps with practice value and to solve life's Monotonous tasks.
          </p>
        </div>
