...
export default function Contact() {
    return (
    <section id="contact" className="relative bg-gray-500">
      <div className="container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap">
        <div className="lg:w-2/3 md:w-1/2 bg-gray-900 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
          <iframe
            ...
            src="https://www.google.com/maps/embed/v1/place?q=97+africa&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8"
          />
        ...
        <form
          ...
          <p className="leading-relaxed mb-5">
            Are you looking to collaborate with me on your next project? Feel free to reach out to me with a message. I can't wait to hear back from you!
          </p>
